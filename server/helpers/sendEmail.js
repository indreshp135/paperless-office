...
const sendEmail = (fileHash, adminEmail, studentEmail) => {
	...
	const toAdmin = {
		...
		html: `<p>A student has requested a document, please verify it. Link to application: https://ipfs.io/ipfs/${fileHash}</p>`, // plain text body
	};
	const toStudent = {
		from: "onsitetask@gmail.com", // sender address
		to: studentEmail, // list of receivers
		subject: "Your Request has been Recieved", // Subject line
		html: `<p>We have recieved your request to document. Your application is https://ipfs.io/ipfs/${fileHash}</p>`, // plain text body
	};
