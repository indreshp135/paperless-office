...
commitChaincodeDefinition() {
  ...
  --peerAddresses localhost:7051 --tlsRootCertFiles ${PWD}/organizations/peerOrganizations/administration.scheisse.edu/peers/peer0.administration.scheisse.edu/tls/ca.crt \
    --peerAddresses localhost:9051 --tlsRootCertFiles ${PWD}/organizations/peerOrganizations/students.scheisse.edu/peers/peer0.students.scheisse.edu/tls/ca.crt \
