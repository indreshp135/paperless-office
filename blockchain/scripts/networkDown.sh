...
# stop org3 containers also in addition to administration and students, in case we were running sample to add org3
...
rm -rf organizations/fabric-ca/administration/msp organizations/fabric-ca/administration/tls-cert.pem organizations/fabric-ca/administration/ca-cert.pem organizations/fabric-ca/administration/IssuerPublicKey organizations/fabric-ca/administration/IssuerRevocationPublicKey organizations/fabric-ca/administration/fabric-ca-server.db
